...
namespace Kubernox.Client.Models {
    public class SSHKeyPair : IAdditionalDataHolder, IParsable {
...
#nullable restore
...
#endif
        /// <summary>
        /// Instantiates a new SSHKeyPair and sets the default values.
        /// </summary>
        public SSHKeyPair() {
        ...
        public static SSHKeyPair CreateFromDiscriminatorValue(IParseNode parseNode) {
